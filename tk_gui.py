...
ramka_pokaz_szczegoly.grid(row=1, column=0, columnspan=2, padx=50, pady=50)
...
label_formularz.grid(row=0, column=6, columnspan=2)
label_imie.grid(row=1, column=6, sticky=W)
label_nazwisko.grid(row=2, column=6, sticky=W)
label_posty.grid(row=3, column=6, sticky=W)
label_miejscowosc.grid(row=4, column=6,sticky=W)
